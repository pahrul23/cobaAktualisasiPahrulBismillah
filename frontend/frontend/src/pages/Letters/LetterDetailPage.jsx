...
const LetterDetailPage = () => {
  ...
  const getStatusColor = (status) => {
    switch (status) {
      ...
      case "verifikasi":
        return { bg: "#e0e7ff", text: "#3730a3", label: "Verifikasi" };
      case "ditindaklanjuti":
        return { bg: "#fdf4ff", text: "#86198f", label: "Ditindaklanjuti" };
      default:
            ...
            {editMode ? (
                ...
                >
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleChange("no_disposisi", e.target.value)
                      }
                      style={{
                        width: "100%",
                        padding: "12px 16px",
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleChange("asal_surat", e.target.value)
                      }
                      style={{
                        width: "100%",
                        padding: "12px 16px",
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleChange("tanggal_terima", e.target.value)
                      }
                      style={{
                        width: "100%",
                        padding: "12px 16px",
                  ...
                  >
                    ...
                    >
                      <div>
                        ...
                        <input
                          type="date"
                          value={
                            formatDateForInput(formData.hari_tanggal_acara) ||
                            ""
                          }
                          onChange={(e) =>
                            handleChange("hari_tanggal_acara", e.target.value)
                          }
                          style={{
                            width: "100%",
                            padding: "12px 16px",
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleChange("pukul", e.target.value)
                          }
                          style={{
                            width: "100%",
                            padding: "12px 16px",
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleChange("tempat", e.target.value)
                          }
                          style={{
                            width: "100%",
                            padding: "12px 16px",
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleChange("jenis_acara", e.target.value)
                          }
                          style={{
                            width: "100%",
                            padding: "12px 16px",
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleChange("dress_code", e.target.value)
                          }
                          style={{
                            width: "100%",
                            padding: "12px 16px",
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) =>
                            handleChange("rsvp_required", e.target.value)
                          }
                          style={{
                            width: "100%",
                            padding: "12px 16px",
                    ...
                    <div style={{ marginTop: "16px" }}>
                      ...
                      <textarea
                        ...
                        onChange={(e) =>
                          handleChange("dokumentasi", e.target.value)
                        }
                        style={{
                          width: "100%",
                          padding: "12px 16px",
                  ...
                  >
                    ...
                    >
                      <div>
                        ...
                        <input
                          type="date"
                          value={
                            formatDateForInput(formData.hari_tanggal) || ""
                          }
                          onChange={(e) =>
                            handleChange("hari_tanggal", e.target.value)
                          }
                          style={{
                            width: "100%",
                            padding: "12px 16px",
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleChange("nama_pemohon", e.target.value)
                          }
                          style={{
                            width: "100%",
                            padding: "12px 16px",
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleChange("jumlah_peserta", e.target.value)
                          }
                          style={{
                            width: "100%",
                            padding: "12px 16px",
                    ...
                    <div style={{ marginTop: "16px" }}>
                      ...
                      <textarea
                        ...
                        onChange={(e) =>
                          handleChange("topik_audiensi", e.target.value)
                        }
                        style={{
                          width: "100%",
                          padding: "12px 16px",
                    ...
                    >
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleChange("nama_pengirim", e.target.value)
                          }
                          style={{
                            width: "100%",
                            padding: "12px 16px",
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleChange("judul_proposal", e.target.value)
                          }
                          style={{
                            width: "100%",
                            padding: "12px 16px",
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleChange("jenis_kegiatan", e.target.value)
                          }
                          style={{
                            width: "100%",
                            padding: "12px 16px",
                      ...
                      <div>
                        ...
                        <input
                          type="date"
                          value={
                            formatDateForInput(formData.tanggal_kegiatan) || ""
                          }
                          onChange={(e) =>
                            handleChange("tanggal_kegiatan", e.target.value)
                          }
                          style={{
                            width: "100%",
                            padding: "12px 16px",
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleChange("total_anggaran", e.target.value)
                          }
                          style={{
                            width: "100%",
                            padding: "12px 16px",
                    ...
                    >
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) =>
                            handleChange("jenis_pengaduan", e.target.value)
                          }
                          style={{
                            width: "100%",
                            padding: "12px 16px",
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) =>
                            handleChange("tingkat_urgensi", e.target.value)
                          }
                          style={{
                            width: "100%",
                            padding: "12px 16px",
                    ...
                    >
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) =>
                            handleChange("tingkat_prioritas", e.target.value)
                          }
                          style={{
                            width: "100%",
                            padding: "12px 16px",
                      ...
                      <div>
                        ...
                        <input
                          type="date"
                          value={
                            formatDateForInput(formData.batas_waktu_respon) ||
                            ""
                          }
                          onChange={(e) =>
                            handleChange("batas_waktu_respon", e.target.value)
                          }
                          style={{
                            width: "100%",
                            padding: "12px 16px",
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) =>
                            handleChange("follow_up_required", e.target.value)
                          }
                          style={{
                            width: "100%",
                            padding: "12px 16px",
              ...
              <div style={{ display: "grid", gap: "32px" }}>
                        ...
                        >
                          ...
                          {letter.total_anggaran && (
                            <div>
                              ...
                              >
                                Rp{" "}
                                {Number(letter.total_anggaran).toLocaleString(
                                  "id-ID"
                                )}
                              </div>
                            </div>
                ...
                {letter.jenis === "pengaduan" &&
                  (letter.jenis_pengaduan || letter.tingkat_urgensi) && (
                    <div>
                      <h3
                        style={{
                          margin: "0 0 16px 0",
                        ...
                        >
                          {letter.kategori_pemberitahuan && (
                            <div>
                              ...
                              >
                                {letter.kategori_pemberitahuan.replace(
                                  /_/g,
                                  " "
                                )}
                              </div>
                ...
                >
                  <div style={{ marginBottom: "8px" }}>
                    <strong>Dibuat oleh:</strong> Staf Sekretariat Ketua DPD RI
                  </div>
                  <div>
