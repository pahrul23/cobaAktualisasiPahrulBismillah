...
const AddLetter = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.no_surat || !formData.asal_surat || !formData.perihal || !formData.uraian) {
  ...
  const renderFormComponent = () => {
    switch(selectedJenis) {
      case 'pengaduan':
        return <PengaduanFormFields formData={formData} setFormData={setFormData} readOnly={false} />
      case 'undangan':
        return <UndanganFormFields formData={formData} setFormData={setFormData} readOnly={false} />
      case 'audiensi':
        return <AudiensiFormFields formData={formData} setFormData={setFormData} readOnly={false} />
      case 'proposal':
        return <ProposalFormFields formData={formData} setFormData={setFormData} readOnly={false} />
      case 'pemberitahuan':
        return <PemberitahuanFormFields formData={formData} setFormData={setFormData} readOnly={false} />
      default:
        return null
    }
  }
        ...
        <div style={{ marginBottom: '32px' }}>
          <div style={{
            ...
            <h1 style={{
              ...
              {selectedJenis ? `Form ${jenisOptions.find(j => j.value === selectedJenis)?.label}` : 'Pilih Jenis Surat'}
            </h1>
          </div>
          <p style={{
            margin: 0,
